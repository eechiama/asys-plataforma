...
void Kit_Init(void){
	...
	//Inicialización de UART0 en 115200, 8bits, No Parity, 1 bit de stop
	UART0_Initialize();

	//Inicialización de ADC en modo "Software Controlled" de canal AD0.2, con interrupción.
	ADC_Init();
	//Inicialización del timer para el ADC
	ADC_Timer0_Init();
